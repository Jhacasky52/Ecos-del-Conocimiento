...
#include "../../../../../../Desktop/terminaa/EcosDelConocimiento/src/core/GameManager.h"
...
Q_CONSTINIT const QMetaObject GameManager::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11GameManagerE_t,
        ...
        // method 'estadoCambiado'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<EstadoJuego, std::false_type>,
        // method 'nivelCambiado'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void GameManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->estadoCambiado((*reinterpret_cast< std::add_pointer_t<EstadoJuego>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (GameManager::*)(EstadoJuego );
            if (_q_method_type _q_method = &GameManager::estadoCambiado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_q_method_type _q_method = &GameManager::nivelCambiado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GameManager::estadoCambiado(EstadoJuego _t1)
{
...
// SIGNAL 1
void GameManager::nivelCambiado(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
