...
#include "../../../../../../Desktop/terminaa/EcosDelConocimiento/src/gui/Nivel2.h"
...
void Nivel2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Nivel2::*)(int );
        ...
        }
        {
            ...
            if (_q_method_type _q_method = &Nivel2::nivelFallido; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Nivel2::nivelCompletado(int _t1)
{
